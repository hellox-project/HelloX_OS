...
BMPIMAGE* LoadBitmap(HANDLE hFile);
         ...
         extern void BmpShow(CDC* pDC, int x, int y, BMPIMAGE *image);
         
         //other functions
         extern void Bmp2Txt(BMPIMAGE *image, FILE *OutTxt);
         extern void Get16Num(unsigned char *orin, char *str);
         void BmpShowArray(CDC* pDC, int x, int y, int height, int width, BYTE *DataB, BYTE *DataG, BYTE *DataR);
