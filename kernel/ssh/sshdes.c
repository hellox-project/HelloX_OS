...
void des_decrypt_xdmauth(const unsigned char *keydata, unsigned char *blk, int len)
{
    DESContext dc;
...
static   ssh2_cipher ssh_3des_ssh2 = 
{
...
static   ssh2_cipher ssh_3des_ssh2_ctr = {
    des3_make_context, des3_free_context, des3_iv, des3_key,
 ...
 */
static ssh2_cipher ssh_des_ssh2 = {
...
static   ssh2_cipher ssh_des_sshcom_ssh2 = {
    des_make_context, des3_free_context, des3_iv, des_key,
    des_ssh2_encrypt_blk, des_ssh2_decrypt_blk,
    "des-cbc@ssh.com",
    8, 56, SSH_CIPHER_IS_CBC, "single-DES CBC"
...
static   ssh2_cipher * des3_list[] = {
    &ssh_3des_ssh2_ctr,
    &ssh_3des_ssh2
};

  ssh2_ciphers ssh2_3des = {
    sizeof(des3_list) / sizeof(*des3_list),
    des3_list
};

static   ssh2_cipher * des_list[] = {
    &ssh_des_ssh2,
    &ssh_des_sshcom_ssh2
};

ssh2_ciphers ssh2_des = {
...
void smemclr(void *p, size_t size) 
{
	memset(p, 0, size); 
}
