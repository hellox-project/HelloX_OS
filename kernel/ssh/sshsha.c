...
static void SHA_Simple(const void *p, int len, unsigned char *output)
{
    SHA_State s;
...
const  ssh_mac ssh_hmac_sha1_96 = {
    sha1_make_context, sha1_free_context, sha1_key,
...
const  ssh_mac ssh_hmac_sha1_buggy = {
...
const  ssh_mac ssh_hmac_sha1_96_buggy = {
    sha1_make_context, sha1_free_context, sha1_key_buggy,
    sha1_96_generate, sha1_96_verify,
    hmacsha1_start, hmacsha1_bytes,
    hmacsha1_96_genresult, hmacsha1_96_verresult,
