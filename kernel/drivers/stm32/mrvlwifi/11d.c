			  ...
			  struct parsed_region_chan_11d * parsed_region_chan)
{
	...
	lbs_deb_hex(LBS_DEB_11D, "parsed_region_chan", (u8 *)chanpwr,
				  ...
				  struct lbs_802_11d_domain_reg *domaininfo)
{
	...
	lbs_deb_hex(LBS_DEB_11D, "domaininfo", (u8 *)domaininfo,
		COUNTRY_CODE_LEN + 1 +
				 ...
				 struct parsed_region_chan_11d *parsed_region_chan)
{
	...
	lbs_deb_hex(LBS_DEB_11D, "countrycode", (u8 *)countryinfo->countrycode,
		COUNTRY_CODE_LEN);
 ...
 *  @return 	      0
*/
//设置要扫描的通道，就是一般的802.11b/g所支持的2.4GHZ所有信道，一共14个
