...
#define HX_PCI_DEVICE_ID_INTEL_I218 0x15a2
#define HX_PCI_DEVICE_ID_INTEL_I212 0x155a
...
void net_process_received_packet(__ETHERNET_INTERFACE* pInt, unsigned char* packet, int length);
