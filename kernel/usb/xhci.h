...
//Only available when CONFIG_USB_XHCI is enabled.
...
#ifndef CONFIG_SYS_USB_XHCI_MAX_ROOT_PORTS
...
static inline u64 xhci_readq(__le64 volatile *regs)
{
	...
	u64 val_lo = __readl(ptr);
	u64 val_hi = __readl(ptr + 1);
...
#ifdef __MS_VC__
	__declspec(align(ARCH_DMA_MINALIGN)) struct xhci_device_context_array *dcbaa;
#else
