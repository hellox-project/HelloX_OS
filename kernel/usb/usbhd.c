...
unsigned long __usbReadSector(int dev, DWORD dwStartSect, DWORD dwSectNum, BYTE* pBuffer)
{
	return usb_stor_read(dev, dwStartSect, dwSectNum, pBuffer);
}

unsigned long __usbWriteSector(int dev, DWORD dwStartSect, DWORD dwSectNum, BYTE* pBuffer)
{
