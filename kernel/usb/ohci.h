...
//Only available when OHCI is enabled.
#ifdef CONFIG_USB_OHCI

#ifndef CONFIG_PCI_OHCI
#define CONFIG_PCI_OHCI
#endif

//Controller's name.
#ifndef CONFIG_SYS_USB_OHCI_SLOT_NAME
#define CONFIG_SYS_USB_OHCI_SLOT_NAME "USB_OHCI"
#endif
...
#ifdef __MS_VC__
# define ohci_writel(a, b) (*((volatile u32 *)(b)) = (a))
#else
...
/* usb_ohci_ed */
#ifdef __MS_VC__
__declspec(align(ED_ALIGNMENT)) struct ed {
#else
struct ed{
#endif
	__u32 hwINFO;
...
#ifdef __MS_VC__
__declspec(align(TD_ALIGNMENT)) struct td {
#else
struct td {
#endif
	__u32 hwINFO;
...
#ifdef __MS_VC__
__declspec(align(256)) struct ohci_hcca{
#else
struct ohci_hcca {
#endif
...
*/
#ifdef __MS_VC__
__declspec(align(32)) struct ohci_regs{
#else
struct ohci_regs {
#endif
...
#ifdef __MS_VC__
	__declspec(align(ED_ALIGNMENT)) ed_t ed[NUM_EDS];
	__declspec(align(ED_ALIGNMENT)) td_t tds[NUM_TD];
#else
...
#ifdef __MS_VC__
	__declspec(align(TD_ALIGNMENT)) struct ohci_device ohci_dev;
	__declspec(align(TD_ALIGNMENT)) struct ohci_device int_dev[NUM_INT_DEVS];
#else
