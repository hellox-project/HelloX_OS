...
//    Module Name               : sockets.c
//    Module Funciton           : 
//                                Implementation code of socket API for HelloX
//                                operating system,just trap to kernel by interrupt
//                                and the actual function are in kernel,which
//                                are ported from lwIP mainly,with some critical
//                                revision to improving performance or other aspects
//                                for general OS.
//
//    Lines number              :
//***********************************************************************/
