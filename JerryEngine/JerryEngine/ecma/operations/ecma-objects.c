                                                                  ...
                                                                  *   false - list only own properties */
{
  ...
  //Replace dynamic array with predefined macros.
  //uint32_t names_hashes_bitmap[ECMA_OBJECT_HASH_BITMAP_SIZE / bitmap_row_size];
  __CREATE_DYNAMIC_ARRAY(uint32_t, names_hashes_bitmap, (ECMA_OBJECT_HASH_BITMAP_SIZE / bitmap_row_size));
                                                        ...
                                                        : NULL)
  {
	...
	__CREATE_DYNAMIC_ARRAY(uint32_t, own_names_hashes_bitmap, (ECMA_OBJECT_HASH_BITMAP_SIZE / bitmap_row_size));
	...
	__RELEASE_DYNAMIC_ARRAY(own_names_hashes_bitmap);
  }

  //Release hash tables created by __CREATE_DYNAMIC_ARRAY macro.
  __RELEASE_DYNAMIC_ARRAY(names_hashes_bitmap);
